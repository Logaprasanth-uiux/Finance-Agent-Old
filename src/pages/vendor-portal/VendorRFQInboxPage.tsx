...
export const VendorRFQInboxPage: React.FC = () => {
      ...
      >
        ...
        <div>
          <div className="vp-rfq-meta-items">
            ...
            {pres.quotationValue && (
              <div className="vp-rfq-meta-item">
                <span>Quoted: <strong>â‚¹{pres.quotationValue.toLocaleString('en-IN')}</strong></span>
              </div>
            )}
          </div>
...
export default VendorRFQInboxPage;
