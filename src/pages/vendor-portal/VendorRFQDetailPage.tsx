...
import type { VendorQuotation, VendorResponse } from '../../types/rfq';
...
export const VendorRFQDetailPage: React.FC = () => {
  ...
  if (!rfq) {
    return (
      <div className="vp-placeholder-container">
        ...
        <Link to="/vendor-portal/rfq" className="vp-detail-back-btn">
          <ArrowLeft size={15} />
    ...
    <div className="vp-detail-wrapper">
      ...
      {viewMode === 'entry' && (
        <>
          ...
          <div className="vp-action-bar">
            <Link to="/vendor-portal/rfq" className="vp-btn-secondary">
              Cancel
            </Link>
            <button
              type="button"
      ...
      {viewMode === 'submitted' && (
        <div className="vp-detail-wrapper" style={{ padding: 0 }}>
          ...
          {/* Final Action Row */}
          <div className="vp-action-bar">
            <Link to="/vendor-portal/rfq" className="vp-btn-primary-action">
              <ArrowLeft size={15} />
              <span>Back to RFQ Inbox</span>
            </Link>
          </div>
...
export default VendorRFQDetailPage;
