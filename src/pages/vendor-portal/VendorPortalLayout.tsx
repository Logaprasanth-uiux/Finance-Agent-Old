...
export const VendorPortalLayout: React.FC = () => {
    ...
    <div className="vp-layout">
      ...
      <header className="vp-top-header">
        <div className="vp-top-header-inner">
          ...
          <Link to="/vendor-portal" className="vp-brand-container">
      ...
      <section className="vp-context-bar">
        <div className="vp-context-bar-inner">
          ...
          <div className="vp-context-actions">
            ...
            <Link to="/dashboard" className="vp-back-to-finance-btn" title="Return to Finance Agent">
              <ArrowLeft size={14} />
